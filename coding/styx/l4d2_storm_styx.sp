...
Menu g_hMenuMain;
int g_iLightStyle[MAXPLAYERS+1];
...
{
	name = "[L4D2] Weather Control Styx",
	author = "SilverShot, Lind3ey",
...
public void OnPluginStart()
{
	...
	g_hCvarModesOff =	CreateConVar(	"l4d2_storm_modes_off",		"versus,coop",				"Turn off the plugin in these game modes, separate by commas (no spaces). (Empty = none).", CVAR_FLAGS );
	...
	g_hCvarRand =	CreateConVar(		"l4d2_storm_random",		"0",			"0=Off. 1=On. Select a new weather preset from the random section when changing chapter.", CVAR_FLAGS);
